<%@ Page Title="" Language="C#" MasterPageFile="~/UILayer/Master1.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="Research_Project.Admin.ChangePassword" %>
...
<table style="border: 1px solid black">
    ...
    <tr>
        ...
        <td>
            ...
            Text="Save" onclick="btnSave_Click" Width="70px" CssClass="smallButton" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
