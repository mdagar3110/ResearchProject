...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
<br />
    <asp:FileUpload ID="imgUpload" runat="server" AllowMultiple="true" CssClass="smallButton" />

    <br />
<br />

    <asp:Button ID="btnSubmit" runat="server" Text="Upload Images" OnClick="btnSubmit_Click" CssClass="smallButton" />
